...
const LogCard = memo(({ log, collapsed, loadingReferenced, onToggleExpand, onNavigateToBlock, parentTimestamp }: LogCardProps) => {
    ...
    return (
        <div style={{ marginBottom: 'var(--space)' }}>
            ...
            {ref && (
                <div className="card clickable" onClick={handleBlockCardClick} style={{
                    marginTop: 'var(--space)', background: '#eff6ff', border: '2px solid var(--primary)',
                    cursor: 'pointer'
                }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 'var(--space)' }}>
                ...
                Click to view
                    ...
                    <div style={{ fontSize: '16px', fontWeight: 600, marginBottom: '8px' }}>{ref.name}</div>
                    ...
                    <div style={{
                        ...
                        <span style={{ color: ref.endTime ? '#059669' : '#d97706', fontWeight: '500' }}>
              {ref.endTime ? '✅ Completed' : '⏳ Running'}
                    ...
                    {ref.endMessage && (
                        <div style={{
                            padding: '6px 8px', background: '#f0f4ff', borderRadius: '6px',
                            fontStyle: 'italic', borderLeft: '3px solid var(--primary)',
